...
Værd at bemærke:
- Hvis netværk fejler, vil de prædefinerede ord stadig være tilgængelige
- Der er brugt state-pattern og singleton-pattern på programlogikken
- Der er brugt en del kræfter på at få backstacken til at fungere korrekt i alle situationer
